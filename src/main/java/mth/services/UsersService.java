...
public class UsersService {
	...
	public Object signin(Map<String, Object> data)
	{
		...
		try
		{
			...
			// Check entered password against BCrypt password
			...
			response.put("jwt", JWT.generateToken(
					U.getEmail(),
					U.getRole(),
					U.getId()
			));
	...
	public Object saveUser(Users U, String token)
	{
		...
		try
		{
			...
			// Encrypt/Hash password before saving
			U.setPassword(passwordEncoder.encode(U.getPassword()));

			UR.save(U); // Create/Insert Operation
